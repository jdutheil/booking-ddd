...
import { OrganizerCreatedEvent } from '@src/modules/organizer/domain/events/organizer-created.event';
import { OrganizerInMemoryRepository } from '@src/modules/organizer/infrastructure/persistence/organizer.in-memory.repository';
